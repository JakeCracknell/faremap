...
// TODO duplicated where a split ticket generated by both peak and off-peak dijkstra.  SAC -> OXS
// function removeDuplicatedFares(fares) {
//     return fares.filter((fare, index, self) => self.findIndex(f =>
//         f.price === fare.price && f.ticketType === fare.ticketType && f.routeDescription === fare.routeDescription) === index);
// }
